...
convert "$line" -bordercolor white -border 1x1 -alpha set -channel RGBA -fuzz .2% -fill none -floodfill +0+0 white -shave 1x1 "$line"

#Eliminar borde negro
convert "$line" -bordercolor black -border 1x1 -alpha set -channel RGBA -fuzz .2% -fill none -floodfill +0+0 black -shave 1x1 "$line"
